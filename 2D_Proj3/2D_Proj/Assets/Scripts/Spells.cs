...
{
    public MagicSpell(int id, string name, string desc, spell_Type spellType, Vector3 damage, Vector3 absorb)
    {
        ID = id;
        Name = name;
...
public class Spells : MonoBehaviour
{
    public MagicSpell[] ElderSpells = new MagicSpell[] {
        new MagicSpell(0, "Fireball", "Flying light fireball.",(spell_Type)(0),  new Vector3(20, 0, 0), Vector3.zero)
    };
}
